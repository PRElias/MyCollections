...
namespace MyCollections.Migrations
{
    ...
    [Migration("20181005165918_separated_gameDetails")]
    partial class separated_gameDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyCollections.Models.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyCollections.Models.Game", b =>
                {
                    ...
                    b.HasOne("MyCollections.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
